...
public class GUINukeCustom extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		text = new String[] { EnumChatFormatting.YELLOW + "Yield",
			EnumChatFormatting.ITALIC + "\"Probably not ice cream but the label came off.\"" };
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft - 16, guiTop + 90, 16, 16, guiLeft - 8, guiTop + 36 + 16, text);
	}
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
		...
		this.drawInfoPanel(guiLeft - 16, guiTop + 90, 16, 16, 2);
	}
}
