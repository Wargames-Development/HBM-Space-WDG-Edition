...
public class TileEntityDemonLamp extends TileEntityPartyOwned {
	...
	private void radiate(World world, int x, int y, int z) {
		...
		for(EntityLivingBase e : entities) {
			if(e instanceof EntityPlayer && !Integrations.canHarmPlayerWGC(ownerParty,e.getUniqueID(),world)) {
				continue;
			}
