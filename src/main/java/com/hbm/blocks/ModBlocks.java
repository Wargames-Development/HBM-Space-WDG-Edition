...
public class ModBlocks {
	...
	public static Block machine_station_drive_terminal;
	...
	private static void initializeBlock() {
		...
		det_miner = new DetMiner(Material.iron).setBlockName("det_miner").setCreativeTab(MainRegistry.nukeTab).setHardness(0.1F).setResistance(0.0F).setBlockTextureName(RefStrings.MODID + ":det_miner_side");
		...
		machine_station_drive_terminal = new MachineStationDriveTerminal(Material.iron).setBlockName("machine_station_drive_terminal").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":block_steel_machine");
		...
		transition_seal = new BlockDoorGeneric(Material.iron, DoorDecl.TRANSITION_SEAL).setBlockName("transition_seal").setHardness(10.0F).setResistance(5_000.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":transition_seal");
	...
	private static void registerBlock() {
		...
		register(machine_station_drive_terminal);
