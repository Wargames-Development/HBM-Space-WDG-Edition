...
public class EntityB92Beam extends Entity implements IProjectile
{
    ...
    public UUID getOwnerParty() {
        if (this.ownerParty == null && this.shootingEntity instanceof EntityPlayer) {
            this.ownerParty = this.shootingEntity.getUniqueID();
        }
        ...
        else
        {
            ...
            for (i = 0; i < list.size(); ++i)
            {
                ...
                if (entity1 instanceof EntityPlayer
                    && !Integrations.canHarmPlayerWGC(this.getOwnerParty(), entity1.getUniqueID(), this.worldObj)) {
                    continue;
                }
	...
	public void writeEntityToNBT(NBTTagCompound p_70014_1_)
    {
        ...
        if (this.getOwnerParty() != null) {
            p_70014_1_.setString("ownerParty", this.getOwnerParty().toString());
        }
    }
	...
	public void readEntityFromNBT(NBTTagCompound p_70037_1_)
    {
        ...
        if (p_70037_1_.hasKey("ownerParty")) {
            try {
                this.ownerParty = UUID.fromString(p_70037_1_.getString("ownerParty"));
    ...
    private void explode() {
        ...
        UUID owner = this.getOwnerParty();

        if (!Integrations.canDetonateWGC(owner, this.worldObj, x, y, z)) {
            this.setDead();
            return;
        }

        this.setDead();
        EntityNukeExplosionMK3 ex = EntityNukeExplosionMK3.statFacFleija(owner, this.worldObj, this.posX, this.posY, this.posZ, 10);
        if (!ex.isDead) {
