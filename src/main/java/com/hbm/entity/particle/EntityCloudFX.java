...
public class EntityCloudFX extends EntityModFX {
	...
	public EntityCloudFX(UUID owner, World p_i1226_1_, double p_i1226_2_, double p_i1226_4_, double p_i1226_6_, double p_i1226_8_, double p_i1226_10_, double p_i1226_12_, float p_i1226_14_)
    {
	...
	public void onUpdate() {
		...
		if (!worldObj.isRemote && rand.nextInt(50) == 0)
			ExplosionChaos.c(owner,worldObj, (int) posX, (int) posY, (int) posZ, 2);
