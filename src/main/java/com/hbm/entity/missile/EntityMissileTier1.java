...
public abstract class EntityMissileTier1 extends EntityMissileBaseNT {
	...
	public static class EntityMissileCluster extends EntityMissileTier1 {
		...
		@Override public void onMissileImpact(MovingObjectPosition mop) {
			if(mop == null) {
				ExplosionChaos.cluster(ownerParty,this.worldObj, (int) this.posX, (int) this.posY, (int) this.posZ, 25,this.rotationYaw, this.rotationPitch, (float) Math.PI * 0.25F, (float) Math.PI * 0.25F, 1F);
				this.killMissile();
			}
			else{
