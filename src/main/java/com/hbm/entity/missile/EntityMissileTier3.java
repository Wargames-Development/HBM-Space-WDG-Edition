...
public abstract class EntityMissileTier3 extends EntityMissileBaseNT {
	...
	public static class EntityMissileRain extends EntityMissileTier3 {
		...
		@Override public void onMissileImpact(MovingObjectPosition mop) {
			if(mop == null) {
				ExplosionChaos.cluster(ownerParty,this.worldObj, (int) this.posX, (int) this.posY, (int) this.posZ, 100, this.rotationYaw, this.rotationPitch, (float) Math.PI * 0.25F, (float) Math.PI * 0.25F, 1F);
				this.killMissile();
			}
			else {
